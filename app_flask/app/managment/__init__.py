...
from app_flask.app.managment.permiso.controller import c_permiso, u_permiso, d_permiso, v_permiso, s_permiso
...
managment.add_url_rule('/permiso/view',view_func=v_permiso, methods=['GET'])
managment.add_url_rule('/rol/view',view_func=v_rol, methods=['GET'])
managment.add_url_rule('/usuario/view',view_func=v_usuario, methods=['GET'])
